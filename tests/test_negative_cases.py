...
class TestNegativeCases:
    ...
    def test_missing_amp_parameter_raises_value_error(self, generator):
        ...
        try:
            ...
            error_msg = str(e)
            assert "data/fm9_comprehensive_reference.json" in error_msg or "data/fm9_config.json" in error_msg, \
    ...
    def test_parameter_sourcing_validation(self, generator):
        ...
        for block_name, block in tone_patch.items():
            ...
            assert block_ref_key in fm9_ref or block_type.upper() in fm9_config, \
            ...
            if block_ref_key in fm9_ref and "key_parameters" in fm9_ref[block_ref_key]:
                ...
                for param_name in block["parameters"]:
                    assert param_name in block_ref["key_parameters"], \
