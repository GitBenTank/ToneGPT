...
class BlocksGuideParser:
    ...
    def __init__(self, blocks_guide_path: str = None):
        if blocks_guide_path is None:
            self.blocks_guide_path = (
                Path(__file__).parent.parent.parent
                / "Fractal-Audio-Blocks-Guide (3).pdf"
            )
        else:
            ...
            "amplifier": {
                ...
                "parameters": {
                    "gain": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Preamp gain control",
                    },
                    "master": {
                        "min": 0.0,
                        "max": 10.0,
                    ...
                    "bass": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Bass frequency control",
                    },
                    "mid": {
                        "min": 0.0,
                        "max": 10.0,
                    ...
                    "treble": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Treble frequency control",
                    },
                    "presence": {
                        "min": 0.0,
                        "max": 10.0,
            ...
            "cabinet": {
                ...
                "parameters": {
                    ...
                    "level": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Cabinet output level",
                    },
                    "air": {
                        "min": 0.0,
                        "max": 10.0,
                        "default": 5.0,
                        "unit": "",
                        "description": "Air frequency control",
                    },
                    "proximity": {
                        "min": 0.0,
                        "max": 10.0,
            ...
            "drive": {
                ...
                "parameters": {
                    "gain": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Drive gain control",
                    },
                    "level": {
                        "min": 0.0,
                        "max": 10.0,
            ...
            "delay": {
                ...
                "parameters": {
                    ...
                    "level": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Delay output level",
                    },
                },
                "channels": 4,
                "xy_switching": True,
            ...
            "modulation": {
                ...
                "parameters": {
                    ...
                    "level": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Modulation output level",
                    },
                },
                "channels": 4,
                "xy_switching": True,
            ...
            "pitch": {
                ...
                "parameters": {
                    ...
                    "level": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Pitch output level",
                    },
                },
                "channels": 4,
                "xy_switching": True,
            ...
            "dynamics": {
                ...
                "parameters": {
                    ...
                    "level": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Dynamics output level",
                    },
                },
                "channels": 4,
                "xy_switching": True,
            ...
            "eq": {
                ...
                "parameters": {
                    ...
                    "high_mid_freq": {
                        ...
                        "default": 2000.0,
                        "unit": "Hz",
                        "description": "High-mid frequency",
                    },
                    "high_mid_gain": {
                        "min": -12.0,
                        "max": 12.0,
            ...
            "filter": {
                ...
                "parameters": {
                    ...
                    "level": {
                        ...
                        "default": 5.0,
                        "unit": "",
                        "description": "Filter output level",
                    },
                },
                "channels": 4,
                "xy_switching": True,
    ...
    def save_blocks_data(self, output_file: str = None):
        ...
        for block_type, block_data in self.blocks_data.items():
            ...
            print(
                f"  {block_type}: {param_count} parameters, {channels} channels, XY: {xy_switching}"
            )
